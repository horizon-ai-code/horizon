...
export const ROLE_VISUALS: Record<string, { step: number; icon: string; colorClass: string; colorClassLight: string }> = {
  ...
  Generator: { step: 2, icon: "Layers",       colorClass: "text-[#2aacb8]", colorClassLight: "text-[#1a8a8e]" },
  Validator: { step: 3, icon: "FileCode2",    colorClass: "text-[#00e5ff]", colorClassLight: "text-[#0098aa]" },
